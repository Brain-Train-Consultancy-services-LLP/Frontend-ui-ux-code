...
const blogPosts = [
  {
    ...
    date: "Oct 10, 2025",
    excerpt: "Discover how AI is revolutionizing learning and enabling personalized education experiences.",
  ...
  },
  {
    ...
    date: "Sep 22, 2025",
    excerpt: "Learn how AI and technology solutions are improving patient care and operational efficiency.",
    image: "/blog/healthcare-ai.jpg",
    cta: "Read More",
  },
  {
    title: "Future of Corporate Training",
    date: "Aug 15, 2025",
    excerpt: "Insights into how AI-driven bootcamps and professional training are upskilling teams worldwide.",
  ...
  return (
    <section className="w-full py-20 bg-gradient-to-br from-gray-50 to-slate-100">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-4xl font-bold text-center mb-4">Blog & Insights</h2>
        <p className="text-center text-lg mb-12">
          Stay updated with the latest trends in AI, innovation, and digital transformation.
        </p>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, idx) => (
            <div
              key={idx}
              className="relative bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-transform transform hover:-translate-y-2 hover:scale-105 duration-300"
            >
